...
if __name__ == "__main__":
    ...
    layers = [8, 11, 6, 2]
    # Train a Multi layer perceptron model using Is_Delay as label.
    mlpc = MultilayerPerceptronClassifier(maxIter=100, layers=layers, blockSize=128, seed=1234,labelCol='Is_Delay', featuresCol='features')

    # Chain indexers and model in a Pipeline
    pipeline = Pipeline(stages=[assembler, mlpc])
